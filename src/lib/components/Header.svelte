...
<header class="fixed top-0 left-0 right-0 bg-slate-300 text-gray-800 z-[1000] shadow-md">
	<div class="grid grid-cols-[1fr_auto_1fr] items-center max-w-screen-xl mx-auto px-6 py-5 gap-4">
		...
		<div class="flex items-center justify-start">
			<img src="/images/logo.png" alt="Logo" class="h-logo-sm sm:h-logo-md md:h-logo-lg w-auto" />
		</div>

		<!-- Center title -->
		<h1
			class="text-title-sm sm:text-title-md md:text-title-lg font-bold m-0 text-center whitespace-nowrap"
		>
			CD Dependency Tree
		</h1>
